  ...
  render() {
    ...
    return (
      <div>
        ...
        <div>
          <span>импортировано {this.props.localState.importStore.importResult} записей</span><button onClick={this.props.onImportPriceHystory} >Import price history</button>
        </div>
        <div>
